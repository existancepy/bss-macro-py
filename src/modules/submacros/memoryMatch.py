...
class MemoryMatch():
    ...
    def solveMemoryMatch(self, mmType):
        ...
        middleX = self.robloxWindow.mx+self.robloxWindow.mw//2
        middleY = self.robloxWindow.my+self.robloxWindow.mh//2
        offsetX = 0
        offsetY = 0
        ...
        while currAttempt <= attempts:
            ...
            if currAttempt > attempts:
                mmImg = adjustImage("./images/menu", "mmopen", self.robloxWindow.display_type) #memory match
                if not locateImageOnScreen(mmImg, self.robloxWindow.mx+self.robloxWindow.mw/4, self.robloxWindow.my+self.robloxWindow.mh/4, self.robloxWindow.mw/4, self.robloxWindow.mh/3.5, 0.8):
